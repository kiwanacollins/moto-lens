...
const sampleInstallationSteps = [
    {
        ...
        description: 'Always disconnect the negative battery terminal before working on electrical components to prevent short circuits.',
        estimatedTime: '5 min',
    ...
    },
    {
        ...
        description: 'Carefully remove the mounting bolts and disconnect the electrical connector. Support the headlight while removing to prevent damage.',
    ...
    },
    {
        ...
        description: 'Connect electrical connector first, then position headlight and secure with mounting bolts. Check alignment before final tightening.',
    ...
    },
    {
        ...
        description: 'Reconnect battery and test all headlight functions. Adjust beam alignment if necessary using adjustment screws.',
        estimatedTime: '10 min',
        difficulty: 'easy' as const,
            ...
            <Stack gap="xl">
                ...
                <div>
                    ...
                    <InstallationGuide
                        ...
                        requiredTools={['10mm socket', 'Phillips screwdriver', 'Torx T25', 'Headlight alignment tool']}
                        safetyWarnings={[
