...
import { MdArrowBack, MdCameraAlt, MdQrCode, MdHealthAndSafety } from 'react-icons/md';
...
export const PartScannerPage = () => {
    ...
    return (
        ...
        >
            {/* Fixed Header */}
            <Container size="lg" px="md" py="md" style={{ flexShrink: 0 }}>
                                ...
                                <Stack gap="lg">
                                    <Paper p="md" withBorder bg="gray.0">
                                        <Group gap="sm">
                                            ...
                                            <Text size="sm" c="dark.7" ff="Inter">
                                                <strong>Marking Detection:</strong> Extract part numbers, brand markings,
                                                and technical specifications from the part image.
                                            </Text>
                                        </Group>
                                    </Paper>
