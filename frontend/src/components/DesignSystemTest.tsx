            ...
            <Stack gap="xl">
                ...
                <Paper shadow="sm" p="lg" radius="md" withBorder>
                    ...
                    <SimpleGrid cols={{ base: 1, sm: 3 }} spacing="md">
                        ...
                        >
                            <Text c="white" fw={600} ff="Inter">Electric Blue</Text>
                        ...
                        <Paper
                            ...
                            style={{ border: '2px solid #e4e4e7' }}
                        >
                            <Text c="white" fw={600} ff="Inter">Carbon Black</Text>
                        ...
                        <Paper
                            ...
                            style={{ border: '2px solid #e4e4e7' }}
                        >
                            <Text c="white" fw={600} ff="Inter">Gunmetal Gray</Text>
                            <Code ff="JetBrains Mono" c="white" bg="rgba(0,0,0,0.2)">
                ...
                <Paper shadow="sm" p="lg" radius="md" withBorder>
                    ...
                    <Stack gap="sm">
                        <div>
                            <Text c="dark.6" size="sm" ff="Inter" mb="xs">Inter - UI Text</Text>
                            <Title order={3} c="dark.9" fw={600} ff="Inter">
                                The quick brown fox jumps over the lazy dog
                            </Title>
                        </div>
                        <div>
                            <Text c="dark.6" size="sm" ff="Inter" mb="xs">JetBrains Mono - Technical Data</Text>
                ...
                <Paper shadow="sm" p="lg" radius="md" withBorder>
                    ...
                    <Group gap="md">
                        ...
                        <Badge color="blue.4" variant="outline">OEM Part</Badge>
                        <Badge color="dark.6" variant="light">Compatible</Badge>
                    </Group>
                </Paper>
                ...
                <Card shadow="md" padding="lg" radius="md" withBorder>
                    <Group justify="space-between" mb="md">
                        ...
                        <Badge color="blue.4" variant="filled">Active</Badge>
                    </Group>

                    <Stack gap="sm">
                        <Group gap="xs">
                            <Text c="dark.6" size="sm" ff="Inter">VIN:</Text>
                ...
                {/* Footer */}
                <Paper shadow="xs" p="md" radius="md" withBorder style={{ borderTop: '3px solid ' + BRAND_COLORS.electricBlue }}>
