    ...
    <>
      ...
      >
        <Group mb="lg" align="center" gap="md">
          ...
          />
          <Text ff="Inter" fw={600} c="#0a0a0a" size="lg">
            Vehicle Systems & Components
          </Text>
        </Group>

        <Text ff="Inter" size="sm" c="#52525b" mb="xl">
          Click on any system below to view detailed information, common issues, and available parts
          for your {vehicleYear} {vehicleMake} {vehicleModel}.
        </Text>

        <SimpleGrid cols={{ base: 3, sm: 4, md: 6, lg: 8 }} spacing="md">
            ...
            return (
              ...
              >
                ...
                <Stack gap="xs" align="center" style={{ textAlign: 'center' }}>
                  ...
                  <div>
                    <Text ff="Inter" fw={600} size="xs" c="#0a0a0a">
                      {part.name}
                    </Text>
                  </div>
                </Stack>
