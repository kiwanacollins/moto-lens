                ...
                <div>
                    <Group justify="space-between" align="flex-start" mb="sm">
                        ...
                        <div style={{ textAlign: 'right' }}>
                            ...
                            <Text ff="Inter" fw={600} size="lg" c="#0a0a0a">
                                ${Math.min(...allOptions.map(o => o.price)).toFixed(0)} - ${Math.max(...allOptions.map(o => o.price)).toFixed(0)}
                            </Text>
                        </div>
                    </Group>
                    ...
                    <Paper bg="#10b98115" p="sm" radius="sm" style={{ border: '1px solid #10b98130' }}>
                        <Group gap="xs" align="center">
                            ...
                            <Text ff="Inter" fw={500} size="sm" c="#10b981">
                                ...
                                ({(((oemPrice - Math.min(...allOptions.map(o => o.price))) / oemPrice) * 100).toFixed(0)}%)
                            </Text>
                            <Text ff="Inter" size="xs" c="#52525b">
                                vs OEM pricing
                            </Text>
                ...
                <Stack gap="md">
                    {sortedOptions.map((option, index) => (
                        <Paper
                            ...
                            radius="sm"
                            style={{
                                border: option.id === bestValueOption.id
                            ...
                            <Group justify="space-between" align="flex-start">
                                        ...
                                        <div>
                                            <Group gap="xs" align="center">
                                                ...
                                                <Badge
                                                    size="xs"
                                                    variant="light"
                                                    color={option.type === 'OEM' ? 'blue' : option.type === 'Aftermarket' ? 'green' : 'yellow'}
                                                    ff="Inter"
                                                >
                                                    {option.type}
                                                </Badge>
                                ...
                                <div style={{ textAlign: 'right' }}>
                                    ...
                                    <Text
                                        ff="Inter"
                                        size="xs"
                                        c={option.inStock ? '#10b981' : '#ef4444'}
                                        mt="xs"
                                    >
