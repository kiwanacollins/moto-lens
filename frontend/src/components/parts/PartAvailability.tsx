        ...
        <div>
          ...
          <div style={{ marginTop: '12px' }}>
            ...
            <Progress
              ...
              color={
                inStockCount > totalSuppliers / 2 ? 'green' : inStockCount > 0 ? 'yellow' : 'red'
              }
              size="sm"
              radius="sm"
            />
                    ...
                    <Group gap="sm" align="center" mb="xs">
                      ...
                      <div>
                        ...
                        <Badge
                          ...
                          variant="light"
                          color={
                            supplier.supplierType === 'OEM'
                              ? 'blue'
                              : supplier.supplierType === 'Dealer'
                                ? 'green'
                                : 'gray'
                          }
                          ff="Inter"
        ...
        <Paper bg="#f4f4f5" p="md" radius="sm" style={{ border: '1px solid #e4e4e7' }}>
          <Group justify="space-between" align="center">
            <div>
              ...
              <Text ff="Inter" size="xs" c="#52525b">
                {sortedStock[0]?.supplier} - {sortedStock[0]?.deliveryTime} - $
                {sortedStock[0]?.price.toFixed(2)}
              </Text>
            </div>
            <Button
